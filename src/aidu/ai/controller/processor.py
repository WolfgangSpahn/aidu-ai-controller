...
class Processor(ABC):
    ...
    @abstractmethod
    def run(self, artifact: Artifact, context: Context = None, console=None) -> ProcessorResult:
        """
    ...
    def _to_agent_result(self, response: dict, context: Context) -> ProcessorResult:
        ...
        return ProcessorResult(artifacts=[TextArtifact(id="response", content=response["content"])])
...
class AgentProcessor(Processor):
    ...
    def run(self, artifact: TextArtifact, context: Context, console=None) -> ProcessorResult:
